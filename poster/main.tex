...
\author{John Smith\inst{1}, James Smith\inst{2} and Jane Smith\inst{3}} % Author(s)
...
\begin{center}
\begin{tabular}{ccc}
\includegraphics[width=\linewidth]{nyuad-logo} % change to nyu-logo and nyush-logo accordingly
\end{tabular}
\end{center}
